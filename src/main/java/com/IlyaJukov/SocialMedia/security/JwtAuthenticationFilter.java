package com.IlyaJukov.SocialMedia.security;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        userLogin = jwtProxy.extractUserName(jwt);

        if (StringUtils.isNotEmpty(userLogin) && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetails userDetails = userService.loadUserByLogin().loadUserByUsername(userLogin);

            if (jwtProxy.isTokenValid(jwt, userDetails)) {
